...
/* harmony export */ });
/* harmony import */ var _utils_cookies_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/cookies.js */ "./utils/cookies.js");
...
/* harmony import */ var _newEvent_html__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./newEvent.html */ "./components/newEvent/newEvent.html");
/* harmony import */ var _selectComponent_selectComponent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../selectComponent/selectComponent */ "./components/selectComponent/selectComponent.js");
...
var NewEvent = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(NewEvent, [{
    ...
    value: function connectedCallback() {
      ...
      this.appendChild(_utils_ComponentsHelper__WEBPACK_IMPORTED_MODULE_3__.default.parseElement(_newEvent_html__WEBPACK_IMPORTED_MODULE_4__.default));
      ...
      _utils_ComponentsHelper__WEBPACK_IMPORTED_MODULE_3__.default.elementMultiplier("option", ["data-value"], this.time, this.data.hours);
    ...
    value: function closeTab() {
      this.remove();
      _utils_eventBus__WEBPACK_IMPORTED_MODULE_1__.publish("resetForm");
    }
  }]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ RemoveEvent)
/* harmony export */ });
/* harmony import */ var _utils_cookies_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/cookies.js */ "./utils/cookies.js");
...
/* harmony import */ var _utils_eventBus_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_utils_eventBus_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _removeEvent_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./removeEvent.html */ "./components/removeEvent/removeEvent.html");
/* harmony import */ var _utils_ComponentsHelper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/ComponentsHelper */ "./utils/ComponentsHelper.js");
/* harmony import */ var _utils_store__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/store */ "./utils/store.js");
/* harmony import */ var _removeEvent_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./removeEvent.scss */ "./components/removeEvent/removeEvent.scss");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var RemoveEvent = /*#__PURE__*/function (_HTMLElement) {
  _inherits(RemoveEvent, _HTMLElement);
  ...
  _createClass(RemoveEvent, [{
    ...
    value: function connectedCallback() {
      ...
      this.appendChild(_utils_ComponentsHelper__WEBPACK_IMPORTED_MODULE_3__.default.parseElement(_removeEvent_html__WEBPACK_IMPORTED_MODULE_2__.default));
      this.buttonYes = this.querySelector("#button-yes");
      this.buttonNo = this.querySelector("#button-no");

      this.buttonYes.onclick = function () {
        return _this2.removeEvent(_this2.data.id);
      };
...
/* harmony export */ });
/* harmony import */ var _selectComponent_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./selectComponent.scss */ "./components/selectComponent/selectComponent.scss");
/* harmony import */ var _utils_eventBus_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/eventBus.js */ "./utils/eventBus.js");
/* harmony import */ var _utils_eventBus_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_utils_eventBus_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _selectComponent_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./selectComponent.html */ "./components/selectComponent/selectComponent.html");
/* harmony import */ var _utils_ComponentsHelper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/ComponentsHelper */ "./utils/ComponentsHelper.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var SelectComponent = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(SelectComponent, [{
    ...
    value: function connectedCallback() {
      ...
      this.appendChild(_utils_ComponentsHelper__WEBPACK_IMPORTED_MODULE_3__.default.parseElement(_selectComponent_html__WEBPACK_IMPORTED_MODULE_2__.default));
      ...
      (0,_utils_eventBus_js__WEBPACK_IMPORTED_MODULE_1__.subscribe)("resetForm", function () {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_calendarHeader_calendarHeader_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/calendarHeader/calendarHeader.js */ "./components/calendarHeader/calendarHeader.js");
/* harmony import */ var _components_newEvent_newEvent_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/newEvent/newEvent.js */ "./components/newEvent/newEvent.js");
/* harmony import */ var _components_authComponent_authComponent_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/authComponent/authComponent.js */ "./components/authComponent/authComponent.js");
...
var main = document.querySelector("#main");
customElements.define('auth-component', _components_authComponent_authComponent_js__WEBPACK_IMPORTED_MODULE_2__.default);
customElements.define('calendar-header', _components_calendarHeader_calendarHeader_js__WEBPACK_IMPORTED_MODULE_0__.default);
customElements.define('new-event', _components_newEvent_newEvent_js__WEBPACK_IMPORTED_MODULE_1__.default);
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _get(_getPrototypeOf(EventsAPI.prototype), "get", this).call(this, this.entity);
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _get(_getPrototypeOf(EventsAPI.prototype), "post", this).call(this, this.entity, data);
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _get(_getPrototypeOf(EventsAPI.prototype), "delete", this).call(this, this.entity, id);
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return _get(_getPrototypeOf(EventsAPI.prototype), "put", this).call(this, this.entity, id, data);
...
var ServerApi = /*#__PURE__*/function () {
  ...
  _createClass(ServerApi, [{
    key: "post",
    value: function () {
      var _post = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(entity, data) {
        var body;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return fetch("".concat(this.baseURL, "/").concat(entity), {
                  method: "POST",
                  body: body,
    ...
    value: function _delete(entity, id) {
      return fetch("".concat(this.baseURL, "/").concat(entity, "/").concat(id), {
        method: "DELETE",
        headers: this.headers
      });
    }
    ...
    key: "put",
    value: function put(entity, id, data) {
      var body = JSON.stringify({
        data: JSON.stringify(data)
      });
      fetch("".concat(this.baseURL, "/").concat(entity, "/").concat(id), {
        method: "PUT",
        headers: this.headers,
        body: body
      }).then(function (res) {
...
/* harmony export */ });
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./store */ "./utils/store.js");
...
var Store = /*#__PURE__*/function () {
  ...
  _createClass(Store, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _api_events__WEBPACK_IMPORTED_MODULE_0__.default.get();
    ...
    key: "updatePosition",
    value: function updatePosition(id, drop) {
      this.state.events.forEach(function (item) {
        if (item.id === id) {
          ...
          _api_events__WEBPACK_IMPORTED_MODULE_0__.default.put(id, drop);
        }
      });
    }
  }, {
...
/***/ "./components/removeEvent/removeEvent.html":
/*!*************************************************!*\
  !*** ./components/removeEvent/removeEvent.html ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
// Module
var code = "<template>\r\n    <div class=\"remove-event\">\r\n        <p class=\"remove-event__title\">Are you sure you want to delete «<span id=\"event-name\"></span>» event?</p>\r\n        <div class=\"remove-event__buttons\">\r\n          <button class=\"remove-event__button\" id=\"button-yes\">Yes</button>\r\n          <button class=\"remove-event__button\" id=\"button-no\">No</button>\r\n        </div>\r\n      </div>\r\n</template>";
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (code);
